...
function renderPage() {
  ...
  return '<!DOCTYPE html>'
    ...
    + '<span class="entry-text"><b>助手配图频率</b><span>控制每个助手发图的频率高低</span></span>'
    + '<span class="entry-arrow">→</span>'
    + '</div>'
    ...
    + '<span class="entry-text"><b>方言口音</b><span>让助手说话带点家乡味</span></span>'
    + '<span class="entry-arrow">→</span>'
    + '</div>'
    + '</div>'
    + '</div>' // end home-main
    ...
    + '<span><span class="export-check-name">方言配置</span><br><span class="export-check-desc">各助手的方言开关与浓度</span></span></label>'
